...
# Parse the serialized data using the dictionary defined above
    ...
    dataset = dataset.prefetch(buffer_size=prefetch_buffer_size)                 # number of batches to asynchronously load for better throughput
    return dataset